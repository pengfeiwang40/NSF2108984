...
## Location of combine executable and species definition file
set combine_exec = ${INSTALL_DIR}/combine/combine-terra.exe
...
setenv SPC $EMF_SPC
setenv PLATFORM "v8" # This variable's only purpose in this script is to keep the assigns file from crashing
...
set indir = $PROJECT_ROOT/$CASE/premerged/${SECTOR}_cb6orig
set outdir = $PROJECT_ROOT/$CASE/premerged/${SECTOR}
if (! -e $outdir) mkdir -p $outdir

setenv INFILE1 $indir/emis_mole_${SECTOR}_cb6orig_${BASE_YEAR}${da}_${GRID}_${SPC}_${CASE}.ncf
setenv OUTFILE $outdir/emis_mole_${SECTOR}_${BASE_YEAR}${da}_${GRID}_${SPC}_${CASE}.ncf

if (-e $INFILE1.gz) gunzip -v $INFILE1.gz
if (! -e $INFILE1) continue

$combine_exec

# PAVE can't read files output directly from combine unless we pass them through m3xtract

setenv INFILE $OUTFILE
setenv OUTFILE $INFILE.xt

$IOAPIDIR/m3xtract << eof
