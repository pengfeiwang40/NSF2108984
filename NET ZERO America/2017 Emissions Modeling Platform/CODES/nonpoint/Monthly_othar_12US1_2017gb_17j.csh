...
setenv REPCONFIG_INV3 "${GE_DAT}/smkreport/repconfig/repconfig_area_inv_exhpm25prof_2016beta_11apr2019_v0.txt"
setenv ATPRO_HOURLY "${GE_DAT}/temporal/amptpro_Canada_2010_tpro_hourly_05jan2015_v1"
setenv ATPRO_WEEKLY "${GE_DAT}/temporal/amptpro_Canada_2010_tpro_weekly_05jan2015_v1"
setenv ATPRO_MONTHLY "${GE_DAT}/temporal/amptpro_Canada_2010_tpro_monthly_28nov2018_nf_v2"
setenv GSREFTMP_A "${GE_DAT}/speciation/gsref_othar_cmaq_cb6ae7_2017gb_17j_nf.txt"
setenv EMISINV_I "${CASEINPUTS}/othar/canada_2017interp_transport_nonroad_monthly_svn70_11feb2020_v0.csv"
setenv EMISINV_H "${CASEINPUTS}/othar/canada_2017interp_transport_rail_svn70_11feb2020_v0.csv"
setenv EMISINV_D "${CASEINPUTS}/othar/canada_2017interp_area_other_svn70_11feb2020_v0.csv"
setenv EMISINV_J "${CASEINPUTS}/othar/Mexico_2016INEM_nonpoint_27may2020_v1.csv"
setenv EMISINV_K "${CASEINPUTS}/othar/Mexico_2016INEM_nonroad_27apr2020_v1.csv"
setenv REPCONFIG_INV2_C "${GE_DAT}/smkreport/repconfig/repconfig_area_inv_evpvocprof_2016beta_08feb2019_v0.txt"
setenv REPCONFIG_INV2_B "${GE_DAT}/smkreport/repconfig/repconfig_area_inv_exhvocprof_2016beta_08feb2019_v0.txt"
setenv REPCONFIG_INV2_A "${GE_DAT}/smkreport/repconfig/repconfig_area_inv_vocprof_2016beta_07feb2019_v0.txt"
setenv GSPRO_COMBO "${GE_DAT}/speciation/gspro_combo_canadamexico_2016beta_16nov2018_v0.txt"
setenv AGREF "${GE_DAT}/gridding/amgref_can2015_mex2010_for2016beta_23apr2020_nf_v5.txt"
setenv ATREF "${GE_DAT}/temporal/amptref_Canada_2015_24apr2020_nf_v3"
setenv SRGDESC "${GE_DAT}/gridding/srgdesc_2015Canada_2010Mexico_03dec2018_07jan2019_v2.txt"
setenv SRGPRO "${GE_DAT}/gridding/surrogates/CONUS12_2015CAN_2010MEX_03dec2018/CA_100_NOFILL.txt"
...
setenv SMK_DEFAULT_SRGID "10"
setenv SMKINVEN_FORMULA "PMC=PM10-PM2_5,EXH__PMC=EXH__PM10-EXH__PM2_5"
